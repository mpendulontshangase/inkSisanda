...
import { Phone, Mail, MapPin, Clock, Facebook, Instagram, ArrowLeft } from "lucide-react";
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-400 text-lg max-w-2xl">
                Ready to start a project, enroll in a class, or purchase a
                machine? Reach us directly on WhatsApp.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-3 gap-8 items-stretch">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
                className="lg:col-span-2 bg-gray-50 border border-gray-200 rounded-3xl p-10 flex flex-col items-center gap-8"
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white font-black px-8 py-4 rounded-full text-base transition-all hover:shadow-lg hover:shadow-green-500/30 hover:scale-105"
                >
